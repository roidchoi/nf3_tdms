...
> **마지막 업데이트**: 2026-06-01 (Task-002-B 완료)  
...
|---|---|---|---|
| **collectors** | ✅ | `master_sync.py`, `market_data_loader.py` | SEC 공시 및 KIS 시세 데이터 동기화, 수정계수 자동 계산 |
| **repositories** | ✅ | `master_repo.py`, `price_repo.py` | CIK 기반 마스터 이력 및 일일 주가/수정계수 대용량 DB 적재 최적화 |
