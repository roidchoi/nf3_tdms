...
> **Sub Project**: p4_manager **마지막 업데이트**: 2026-05-26 **타입**: Type E (배경/환경 지식) **공통 환경**: `parent_wiki/environment.md` 참조 (중복 기재 금지)
...
- **환경명**: `tdms_p4_env`
- **생성 방법**: `conda create -n tdms_p4_env python=3.12`
...
|파일|경로|git 포함|주요 내용|
|---|---|---|---|
|`.env`|`tdms_core/p4_manager/.env`|❌|{변수명 목록}|
